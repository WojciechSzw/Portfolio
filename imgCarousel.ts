...
function spinRight() {
    const scrollBox = document.querySelectorAll<HTMLElement>(".projects__scroll-box")[0];
    console.log(scrollBox);
    const scrollItems = document.querySelectorAll<HTMLElement>(".projects__scroll-box__item")
   for(let x = 0; x<3; x++)
   {
